...
class GreedyCoresetSampler(BaseSampler):
    ...
    def run_with_indices(
        ...
        """Subsamples features and returns both the subset and the indices.

        Args:
            features: [N x D]
        Returns:
            subset: sampled features
        ...
        reduced_features = self._reduce_features(features)
        sample_indices = self._compute_greedy_coreset_indices(reduced_features)
        subset = features[sample_indices]
        return self._restore_type(subset), sample_indices
